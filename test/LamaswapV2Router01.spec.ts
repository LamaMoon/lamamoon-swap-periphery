...
enum RouterVersion {
  LamaswapV2Router01 = 'LamaswapV2Router01',
  LamaswapV2Router02 = 'LamaswapV2Router02'
}

describe('LamaswapV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.LamaswapV2Router01]: fixture.router01,
        [RouterVersion.LamaswapV2Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.LamaswapV2Router01]: 101876,
              [RouterVersion.LamaswapV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.LamaswapV2Router01]: 138770,
              [RouterVersion.LamaswapV2Router02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
